...
#                      name                             description                         cmd  bytes       decoder           ECU       fast
    ...
    OBDCommand("Driver_Demand_Engine"       , "Drivers Demand engine"                   , b"0161", 3, percent_torque,        ECU.ENGINE, True),
OBDCommand("62"       , ""                   , b"0162", 3, percent_torque,        ECU.ENGINE, True),
OBDCommand("63"       , ""                   , b"0163", 4, NMUnit,        ECU.ENGINE, True),
OBDCommand("64"       , ""                   , b"0164", 7, percent_torque,        ECU.ENGINE, True),
OBDCommand("65"       , ""                   , b"0165", 4, pid,        ECU.ENGINE, True),
OBDCommand("66"       , ""                   , b"0166", 7, GRAMPERSECFLOWSENSOR,        ECU.ENGINE, True),
OBDCommand("67"       , ""                   , b"0167", 5, tempmulti,        ECU.ENGINE, True),
OBDCommand("68"       , ""                   , b"0168", 5, tempmulti,        ECU.ENGINE, True),
OBDCommand("69"       , ""                   , b"0169", 9, NoUnit,        ECU.ENGINE, True),
OBDCommand("6A"       , ""                   , b"016A", 7, NoUnit,        ECU.ENGINE, True),
OBDCommand("6B"       , ""                   , b"016B", 7, NoUnit,        ECU.ENGINE, True),
OBDCommand("6C"       , ""                   , b"016C", 7, NoUnit,        ECU.ENGINE, True),
OBDCommand("6D"       , ""                   , b"016D", 13, NoUnit,        ECU.ENGINE, True),
OBDCommand("6E"       , ""                   , b"016E", 11, NoUnit,        ECU.ENGINE, True),
OBDCommand("6F"       , ""                   , b"016F", 5, NoUnit,        ECU.ENGINE, True),
OBDCommand("70"       , ""                   , b"0170", 12, NoUnit,        ECU.ENGINE, True),
OBDCommand("71"       , ""                   , b"0171", 8, NoUnit,        ECU.ENGINE, True),
OBDCommand("72"       , ""                   , b"0172", 7, NoUnit,        ECU.ENGINE, True),
OBDCommand("73"       , ""                   , b"0173", 7, NoUnit,        ECU.ENGINE, True),
OBDCommand("74"       , ""                   , b"0174", 7, NoUnit,        ECU.ENGINE, True),
OBDCommand("75"       , ""                   , b"0175", 9, NoUnit,        ECU.ENGINE, True),
OBDCommand("76"       , ""                   , b"0176", 9, NoUnit,        ECU.ENGINE, True),
OBDCommand("77"       , ""                   , b"0177", 7, NoUnit,        ECU.ENGINE, True),
OBDCommand("78"       , ""                   , b"0178", 11, pid,        ECU.ENGINE, True),
OBDCommand("79"       , ""                   , b"0179", 11, pid,        ECU.ENGINE, True),
OBDCommand("7A"       , ""                   , b"017A", 9, NoUnit,        ECU.ENGINE, True),
OBDCommand("7B"       , ""                   , b"017B", 9, NoUnit,        ECU.ENGINE, True),
OBDCommand("7C"       , ""                   , b"017C", 11, DFPTemp,        ECU.ENGINE, True),
OBDCommand("7D"       , ""                   , b"017D", 3, NoUnit,        ECU.ENGINE, True),
OBDCommand("7E"       , ""                   , b"017E", 3, NoUnit,        ECU.ENGINE, True),
OBDCommand("7F"       , ""                   , b"017F", 15, uas(0x12),        ECU.ENGINE, True),
